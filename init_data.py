...
def create_test_data():
    ...
    # Создание владельцев
    owners_data = [
        {'name': 'Иван Петров', 'address': 'Москва, ул. Ленина, 1', 'phone': '+7-495-123-45-67'},
        {'name': 'Мария Сидорова', 'address': 'Санкт-Петербург, Невский пр., 10', 'phone': '+7-812-234-56-78'},
        {'name': 'Алексей Козлов', 'address': 'Казань, ул. Баумана, 5', 'phone': '+7-843-345-67-89'},
    ]
