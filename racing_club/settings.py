"""
Django settings for racing_club project.
...
SECRET_KEY = 'django-insecure-()xg(r(!chbdod&th-7*lxmggw92ceh*%qx3)v-d%3lfy-3tp@'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'racing.context_processors.user_profile_context',
            ],
        },
    },
]

WSGI_APPLICATION = 'racing_club.wsgi.application'
